...
const Hero = () => {
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-12">
            ...
            <div className="absolute flex lg:hidden size-40 rounded-full bg-purple-600 blur-[10rem] top-0 left-1/2 -translate-x-1/2 -z-10"></div>
                ...
                <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
                    <Container className="relative hidden lg:block overflow-hidden">
                        <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center">
                                <span className="px-2 py-[0.5px] h-[18px] tracking-wide flex items-center justify-center rounded-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-[9px] font-medium mr-2 text-white">
                                    NEW
                                </span>
                    ...
                    <Container delay={0.25} className="z-20">
                        <div className="flex flex-col items-center justify-center mt-6">
                            <Link href="https://www.videotto.com/login" className="flex items-center gap-2 group">
                                <Button size="lg">
                                    Sign Up
                                    <ArrowRightIcon className="size-4 group-hover:translate-x-1 transition-all duration-300" />
                                </Button>
                            </Link>
                            <div className="flex items-center justify-center mt-4 gap-x-6 text-sm text-muted-foreground">
                    ...
                    <Container delay={0.3} className="relative">
                        <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
                            <div className="absolute top-1/8 left-1/2 -z-10 bg-gradient-to-r from-purple-500 to-fuchsia-600 w-1/2 lg:w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[4rem] lg:blur-[10rem] animate-image-glow"></div>
                            <div className="hidden lg:block absolute -top-1/8 left-1/2 -z-20 bg-purple-600 w-1/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[10rem] animate-image-glow"></div>
